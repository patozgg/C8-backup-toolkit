            ...
            <div className={"container"}>
                ...
                <div className="row" style={{marginTop: "10px"}}>
                    ...
                    <InlineNotification kind="info" hideCloseButton="true" lowContrast="false">
                        ...
                        the BasePath come from Blueberry (or was created in Elasticseach), the container name come from
                        Blueberry (or was created in Elasticseach)
                    </InlineNotification>
                </div>
                <div className="row" style={{marginTop: "10px"}}>
                    <div className="col-md-2">
                    ...
                    <div className="col-md-2">
                        <b>{this.state.parameters.operateSource}</b>
                    </div>
                    <div className="col-md-6">
                        If Operate open the actuator/env API, then information come directly from Operate. Else, from
                        the configuration.<br/>
                        To open Operate Actuator, add
